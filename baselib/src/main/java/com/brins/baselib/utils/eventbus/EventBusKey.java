...
public class EventBusKey {
    ...
    public static final String KEY_JSBRIDGE_DATA_COMMONJSAPI_ACTIVITYRESULT = "key_jsbridge_data_commonjsapi_activityresult";
    public static final String KEY_JSBRIDGE_DATA_PAYJSAPI_WXPAYENTRYACTIVITY = "key_jsbridge_data_payjsapi_wxpayentryactivity";
    public static final String CHANGE_HOME_BG_COLOR = "CHANGE_HOME_BG_COLOR";
    ...
    public static final String KEY_EVENT_CLICK_MY_LIKE = "KEY_EVENT_CLICK_MY_LIKE";

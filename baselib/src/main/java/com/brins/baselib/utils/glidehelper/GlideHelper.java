...
//            }
    ...
    public static void setImageResource(Context context, String imageUrl, CustomTarget simpleTarget) {//特殊情况，只需要返回bitmap
        try {
            if (context != null) {
    ...
    public static void setBlurImageResource(Context context, String imageUrl, float radius, int width, int height, CustomTarget simpleTarget) {
        if (context != null) {
            Glide.get(context).setMemoryCategory(MemoryCategory.NORMAL);
    ...
    /**************************特殊处理圆形图片*/
    public static void setCircleImageResource(Context context, String res, CustomTarget simpleTarget) {
        try {
            if (context != null) {
                Glide.get(context).setMemoryCategory(MemoryCategory.NORMAL);

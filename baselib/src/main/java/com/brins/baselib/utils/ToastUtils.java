...
public final class ToastUtils {
    ...
    private static int yOffset = (int) (64 * UIUtils.getContext().getResources().getDisplayMetrics().density + 0.5);
     ...
     */
    @UiThread
    private static void showOnUiThread(final CharSequence text, final int duration) {
        cancel();
    ...
    public static void reset() {
        ToastUtils.setMessageColor(DEFAULT_COLOR);
        ToastUtils.setBgResource(-1);
        ToastUtils.setView(null);
        ToastUtils.setGravity(Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM, 0,
                (int) (64 * UIUtils.getContext().getResources().getDisplayMetrics().density + 0.5));
    }
}
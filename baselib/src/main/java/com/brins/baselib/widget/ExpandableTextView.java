...
import static com.brins.baselib.utils.UtilKt.getTopicModel;
import static com.brins.baselib.utils.UtilKt.getUserModel;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    public void setText(@Nullable CharSequence text) {
        ...
        mTv.setRichText(
                text.toString(),
                getUserModel(text.toString()),
                getTopicModel(text.toString()));
        ...
        switch (expandToggleType) {
            case EXPAND_INDICATOR_IMAGE_BUTTON:
                ...
                if (expandDrawable == null) {
                    expandDrawable = getDrawable(context, R.drawable.base_icon_back_down_black);
                }
                if (collapseDrawable == null) {
                    collapseDrawable = getDrawable(context, R.drawable.base_icon_back_up_black);
                }
